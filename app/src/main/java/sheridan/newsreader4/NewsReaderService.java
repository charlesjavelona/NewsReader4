...
public class NewsReaderService extends Service {
    ...
    public void onDestroy() {
        ...
        editor.putLong("FeedMillis", app.getFeedMillis());
        editor.commit();
    }
    ...
    private void startTimer() {
        TimerTask task = new TimerTask() {
            ...
            public void run() {
                ...
                io.downloadFile(app.getLastNewsSite());
                ...
                if (newFeed.getLastBuildDateMillis() > app.getFeedMillis()) {
                    Log.d("News reader", "Updated feed available.");

                    // update app object
                    app.setFeedMillis(newFeed.getLastBuildDateMillis());

                    // display notification
                    sendNotification("Updated feed is available");
        ...
        int delay = 1000 * 60 * 1;      // 1 min
        int interval = 1000 * 60 * 1;   // 1 min
